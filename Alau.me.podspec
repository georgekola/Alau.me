Pod::Spec.new do |s|
  s.name             = 'Alau.me'
  s.version          = '2.1.1'
  s.summary          = 'Add referral tracking to your app on the App Store. Create unique download links to track clicks and actual installs.'
  s.description      = <<-DESC
...
You can create short links for a specific ad campaign, or you can create a unique link for each of your users, and track user-to-user referrals. Alau.me scales to millions of users and is used by hundreds of apps.
  ...
  s.source           = { :git => 'https://github.com/LumenSpark/Alau.me.git', :tag => '2.1.1' }
