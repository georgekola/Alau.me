Pod::Spec.new do |s|
  s.name             = 'Alau.me'
  s.version          = '2.1'
  s.summary          = 'Add referral tracking to your app on the App Store. Create unique download links to track clicks and installs.'
  s.description      = <<-DESC
